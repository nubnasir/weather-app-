...
public class WeatherReport extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE)
			...
			Toast.makeText(WeatherReport.this,
		...
		country_short = weatherIntent.getStringExtra("COUNTRY_SHORT");
	...
	private class AsyncTaskParser extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			...
			progress = new CustomProgressBar(WeatherReport.this);
		...
		protected Boolean doInBackground(Void... arg0) {
			...
			jsonResponseString = WebResponse
					.webConnection("http://api.openweathermap.org/data/2.5/weather?id="
							+ country_short);
		...
		protected void onProgressUpdate(Void... value) {
			...
			try {
				...
				if (wholeJsonObject != null) {
					...
					w_pressure.setText("" + pressure + "HPa");
